...
parser.add_argument('--exp', type=str, default='AC-CPCA', help='experiment_name')
...
def Inference(FLAGS):
    ...
    snapshot_path = "./pretrained_pth/ACDC_{}_{}_labeled/{}".format(FLAGS.exp, FLAGS.labelnum, FLAGS.model)
    test_save_path = "./pretrained_pth/ACDC_{}_{}_labeled/{}_predictions/".format(FLAGS.exp, FLAGS.labelnum, FLAGS.model)
    if os.path.exists(test_save_path):
        shutil.rmtree(test_save_path)
    os.makedirs(test_save_path)
    net = net_factory(net_type='acnet2d_v2', in_chns=1, class_num=FLAGS.num_classes)
